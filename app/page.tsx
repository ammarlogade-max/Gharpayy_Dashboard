    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
              <button onClick={() => router.push('/explore')} className="hover:text-foreground transition-colors font-medium">Explore PGs</button>
              <button onClick={() => router.push('/owner-portal')} className="hover:text-foreground transition-colors">For Owners</button>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="flex items-end justify-between mb-8">
          ...
          <Button variant="ghost" className="gap-1 text-sm" onClick={() => router.push('/explore')}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="rounded-2xl bg-accent/5 border border-accent/10 p-10 sm:p-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button onClick={() => router.push('/explore')} className="h-12 px-8 bg-accent hover:bg-accent/90 text-accent-foreground text-base rounded-xl">
              Explore PGs <ArrowRight size={18} className="ml-1" />
            </Button>
            <Button variant="outline" onClick={() => router.push('/capture')} className="h-12 px-8 text-base rounded-xl">
              List Your Property
            </Button>
          </div>
        </div>
