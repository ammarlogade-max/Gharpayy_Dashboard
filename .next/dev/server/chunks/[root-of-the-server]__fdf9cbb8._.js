...
async function GET() {
    try {
        ...
        const leads = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Lead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).populate('assignedAgentId', 'id name').populate('propertyId', 'id name').sort({
            createdAt: -1
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedLeads);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const lead = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Lead$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(leadData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdf9cbb8._.js.map