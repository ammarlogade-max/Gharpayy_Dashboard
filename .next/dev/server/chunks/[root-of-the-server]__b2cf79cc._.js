...
async function GET() {
    try {
        ...
        const notifications = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Notification$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            createdAt: -1
        }).limit(50);
...
async function PATCH(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        if (all === 'true') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Notification$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateMany({
                isRead: false
            }, {
                isRead: true
            });
        ...
        if (id) {
            const notification = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Notification$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
                isRead: true
            }, {
                new: true
            });
            if (!notification) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2cf79cc._.js.map