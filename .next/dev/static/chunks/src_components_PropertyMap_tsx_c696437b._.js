...
"[project]/src/components/PropertyMap.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PropertyMap({ properties, onPropertyClick, center, zoom = 12, className = '' }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PropertyMap.useEffect": ()=>{
            ...
            markersRef.current = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$leaflet$2f$dist$2f$leaflet$2d$src$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].layerGroup().addTo(mapInstance.current);
            return ({
                "PropertyMap.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PropertyMap.useEffect": ()=>{
            ...
            const validProps = properties.filter({
                "PropertyMap.useEffect.validProps": (p)=>p.latitude && p.longitude
            }["PropertyMap.useEffect.validProps"]);
            if (validProps.length === 0) return;
            validProps.forEach({
                "PropertyMap.useEffect": (p)=>{
      ...
      `;
                    ...
                    marker.on('popupopen', {
                        "PropertyMap.useEffect": ()=>{
                            ...
                            el?.addEventListener('click', {
                                "PropertyMap.useEffect": ()=>onPropertyClick(p.id)
                            }["PropertyMap.useEffect"]);
                        }
                    }["PropertyMap.useEffect"]);
            ...
            // Fit bounds
            const bounds = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$leaflet$2f$dist$2f$leaflet$2d$src$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].latLngBounds(validProps.map({
                "PropertyMap.useEffect.bounds": (p)=>[
                        p.latitude,
                        p.longitude
                    ]
            }["PropertyMap.useEffect.bounds"]));
...
_s(PropertyMap, "PpBl28CGivYfODHMHdBihbSzKC4=");
_c = PropertyMap;
var _c;
...
//# sourceMappingURL=src_components_PropertyMap_tsx_c696437b._.js.map