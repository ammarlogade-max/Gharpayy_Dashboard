...
"[project]/node_modules/@lovable.dev/cloud-auth-js/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var DEFAULT_SUPPORTED_OAUTH_ORIGINS = [
...
function createAuth(config = {}) {
    ...
    async function signInWithOAuth(provider, opts = {}) {
        ...
        try {
            ...
            if (data.state !== state) {
                return {
                    error: new Error("State is invalid")
                };
            }
            if (!data.access_token || !data.refresh_token) {
                return {
                    error: new Error("No tokens received")
                };
            }
            return {
                tokens: {
...
//# sourceMappingURL=node_modules_6b511217._.js.map